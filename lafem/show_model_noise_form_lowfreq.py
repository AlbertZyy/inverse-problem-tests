...
#   ('pos', 'tag',       'type', 'noise', 'filter', 'ckpts_path')
    (6,  'nn_nograd',     'nograd',    0.0,  None, 'lafem/ckpts'),
    (7, 'ln01_nograd',    'nograd',    0.084, low_pass, 'lafem/ckpts'),
    (8, 'ln05_nograd',    'nograd',    0.42, low_pass, 'lafem/ckpts'),

    (10, 'nn_single',   'single', 0.0,  None, 'lafem/ckpts'),
    (11, 'ln01_single', 'single', 0.084, low_pass, 'lafem/ckpts'),
    (12, 'ln05_single', 'single', 0.42, low_pass, 'lafem/ckpts'),

    (14, 'nn_multi',    'multi',  0.0,  None, 'lafem/ckpts'),
    (15, 'ln01_multi',  'multi',  0.084, low_pass, 'lafem/ckpts'),
    (16, 'ln05_multi',  'multi',  0.42, low_pass, 'lafem/ckpts'),
]
...
for i in ID:
    ...
    figs[i].tight_layout()
    figs[i].savefig(os.path.join(save_dir, f'vis_cir3_{i}_lowfreq.png'))
