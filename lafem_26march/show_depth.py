...
low_pass = FractionalDoF(252, device=device)
...
#   ('tag',       'type', 'noise', 'filter', 'ckpts_path')
    ('nn_nograd',      'nograd',    0.0,  None, 'lafem_26march/ckpts'),
    ('ln01_nograd',    'nograd',    0.084, low_pass, 'lafem_26march/ckpts'),
    ('ln05_nograd',    'nograd',    0.42, low_pass, 'lafem_26march/ckpts'),

    ('nn_single',   'single', 0.0,  None, 'lafem_26march/ckpts'),
    ('ln01_single', 'single', 0.084, low_pass, 'lafem_26march/ckpts'),
    ('ln05_single', 'single', 0.42, low_pass, 'lafem_26march/ckpts'),

    ('nn_multi',    'multi',       0.0,  None, 'lafem_26march/ckpts'),
    ('ln01_multi',  'multi',       0.084, low_pass, 'lafem_26march/ckpts'),
    ('ln05_multi',  'multi',       0.42, low_pass, 'lafem_26march/ckpts'),
]
